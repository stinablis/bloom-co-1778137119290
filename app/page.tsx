...
const basePath = '/bloom-co-1778137119290';
...
export default function Home() {
  ...
  const submit = (e: any) => {
    ...
    window.open(`https://wa.me/60112345001?text=${msg}`, '_blank');
  };
  ...
  const products = [{ n: 'Wedding Florals', d: 'Bouquets, centerpieces, and arch arrangements', i: 'https://images.pexels.com/photos/540522/pexels-photo-540522.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Daily Bouquets', d: 'Fresh seasonal flowers, ready to go', i: 'https://images.pexels.com/photos/5414055/pexels-photo-5414055.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Corporate Flowers', d: 'Weekly office arrangements and lobby displays', i: 'https://images.pexels.com/photos/94825/pexels-photo-94825.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Dried Flower Sets', d: 'Long-lasting preserved arrangements', i: 'https://images.pexels.com/photos/6958747/pexels-photo-6958747.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Flower Subscription', d: 'Monthly delivery of curated bouquets', i: 'https://images.pexels.com/photos/34668319/pexels-photo-34668319.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">Bloom & Co.</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/540522/pexels-photo-540522.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Nature\'s beauty, arranged <span className="text-accent">for you..</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Bloom & Co. delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/60112345001`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Bloom & Co., we are a team of passionate florists dedicated to crafting exquisite arrangements that bring joy and beauty to every occasion. With a commitment to using only the freshest, highest-quality blooms, we strive to exceed our clients\' expectations and make their special moments truly unforgettable. By combining creativity, attention to detail, and a deep love of nature, we create stunning floral designs that inspire and delight.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be the premier florist of choice for individuals and businesses seeking exceptional, bespoke floral arrangements that elevate and inspire.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To provide unparalleled customer service, superior quality flowers, and breathtaking arrangements that embody the beauty and essence of nature, while fostering long-term relationships with our clients and community.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Beauty</h4>
                  <p className="text-sm text-on-surface-variant">Every arrangement a living masterpiece.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Freshness</h4>
                  <p className="text-sm text-on-surface-variant">Same-day sourced blooms, always vibrant.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/5894088/pexels-photo-5894088.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/36812294/pexels-photo-36812294.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/35592786/pexels-photo-35592786.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">hello@bloomandco.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">60112345001</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Bloom & Co.</div>
            <p className="text-white/60 text-sm leading-relaxed">Nature\'s beauty, arranged for you.</p>
          </div>
          <div className="flex justify-center md:justify-center gap-6">
            
            
            <a href={`https://wa.me/60112345001`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              © {new Date().getFullYear()} Bloom & Co.. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
